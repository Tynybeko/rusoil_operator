...
export default function ErrorAlert({ desc, title, onClose, btnText, voice }: ErrorAlertProps) {
    ...
    return (
        <Modal className='border rounded-lg overflow-hidden' onClose={onClose}>
            <audio ref={soundRef} src='/sounds/error.mp3'></audio>
            <div className="flex min-h-full justify-center p-4 text-center flex-col max-w-[350px] items-center sm:p-0">
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                        <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full text-red-500 bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
